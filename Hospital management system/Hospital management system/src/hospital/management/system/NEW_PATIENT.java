...
public class NEW_PATIENT extends JFrame implements ActionListener {
    ...
    NEW_PATIENT() {
        ...
        textFieldNumber.addKeyListener(new KeyAdapter() {
            public void keyTyped(KeyEvent e) {
                ...
                if ("Aadhar Card".equals(selectedID)) {
                    if (!Character.isDigit(ch) || textFieldNumber.getText().length() >= 12) {
                        e.consume();
                    }
                }
            }
        ...
        // Deposit validation (only digits)
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b1) {
            ...
            String s4 = (r1.isSelected()) ? "Male" : (r2.isSelected() ? "Female" : "");
            ...
            if (s2.isEmpty() || s3.isEmpty() || s4.isEmpty() || s5.isEmpty() || s8.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Please fill up the form otherwise Patient Admission failed");
                return;
            }

            // Aadhaar length validation
            if ("Aadhar Card".equals(s1) && s2.length() != 12) {
